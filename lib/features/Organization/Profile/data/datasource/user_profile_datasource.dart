...
class UserProfileDataSource extends BaseUserProfileDataSource {
  ...
  Future<void> updateCompanyInfo({
    ...
    print("--- [API REQUEST] updateCompanyInfo ---");
    print("Path: ${ApiConstant.updateCompanyInfo}");
    print("Fields: Name=$name, Industry=$industry, PhoneNumber=$phoneNumber, PhotoPath=$photoPath");
